...
with open('./3-Gram_results.txt', 'r', encoding='utf8') as infile:
    with open('./utilitarios\\3-Gram_results.txt', 'w', encoding='utf8') as outfile:
        ...
        for linha in infile:
            ...
            if validar_pt(termo) == True and verificar_numero(termo) == False:
                if labels[0] == 'PROPN' or labels[0] == 'NOUN' or labels[0] == 'ADJ':
                    if labels[-1] == 'PROPN' or labels[-1] == 'NOUN' or labels[-1] == 'ADJ':
